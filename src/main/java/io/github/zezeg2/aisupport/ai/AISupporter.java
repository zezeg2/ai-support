...
public class AISupporter {
    ...
    public <T> AIFunction<T> createSingleFunction(String functionName, String purpose, Class<T> returnType, List<Constraint> constraintList) {
        return new AISingleFunction<>(functionName, purpose, constraintList, returnType, service, mapper, resolver, formatUtil, promptManager, resultValidatorChain, openAIProperties);
    }
