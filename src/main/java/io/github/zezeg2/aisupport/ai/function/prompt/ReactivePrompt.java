...
public class ReactivePrompt {
    ...
    private final List<ReactiveResultValidator> resultValidators;

    public ReactivePrompt(String purpose, String refTypes, String function, String constraints, String inputFormat, String resultFormat, String feedbackFormat, List<ReactiveResultValidator> resultValidators) {
