...
public class ReactiveAISupporter<S> {
    private final OpenAiService service;
    private final ObjectMapper mapper;
    private final ConstructResolver resolver;
    private final ReactivePromptManager<S> promptManager;
    ...
    public <T> ReactiveAIFunction<?, S> createFunction(STRUCTURE structure, Class<T> returnType, String functionName, String purpose, List<Constraint> constraintList) {
        return switch (structure) {
            case SINGLE ->
                    new ReactiveAISingleFunction<T, S>(functionName, purpose, constraintList, returnType, service, mapper, resolver, promptManager, resultValidatorChain, exceptionValidator, openAIProperties);
            case LIST ->
    ...
    public <T> ReactiveAIFunction<T, S> createSingleFunction(Class<T> returnType, String functionName, String purpose, List<Constraint> constraintList) {
    ...
    public <T> ReactiveAIFunction<List<T>, S> createListFunction(Class<T> returnType, String functionName, String purpose, List<Constraint> constraintList) {
    ...
    public <T> ReactiveAIFunction<Map<String, T>, S> createMapFunction(Class<T> returnType, String functionName, String purpose, List<Constraint> constraintList) {
